...
---
   ...
   ```
   var params = 'lp_campaign_id=' + campaignId + '&lp_campaign_key=' + campaignKey + '&first_name=' + firstName + '&last_name=' + lastName + '&email_address=' + email + '&phone_home=' + phone+ '&lp_request_id=' + lpRequestId;
   ```
